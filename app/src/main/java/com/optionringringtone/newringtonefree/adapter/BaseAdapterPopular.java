...
public class BaseAdapterPopular extends BaseAdapter {
    ...
    public BaseAdapterPopular(Activity activity, List<RingTone> lstRingStone) {
...
//        ringToneDataPlaying.setChangeStatus(true);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iv_btn_more_func = convertView.findViewById(R.id.iv_btn_more_func);
